...
class ClientProfile(object):
    ...
    def __init__(self, signMethod=None, httpProfile=None, language="zh-CN"):
        ...
        :param signMethod: The signature method, valid choice: HMAC-SHA1, HMAC-SHA256
        :type signMethod: str
        ...
        if language not in valid_language:
            raise KsyunSDKException("ClientError", "Language invalid, choices: %s" % valid_language)
